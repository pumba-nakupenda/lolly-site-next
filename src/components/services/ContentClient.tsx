...
// Since the original file imported this, and we found it in src/assets, we might need to adjust.
// If it's a static import in Vite it works. In Next.js, we can also import images if they are in the project.
// However, for consistency and ease, let's assume we can move or reference it.
// If it was in src/assets, in Next.js we usually put static images in public/.
// I'll check if I can use the import if I can't find it in public/assets.
// For now I'll use a placeholder or the assumption it works if configured, but standard is /assets in public.
// I'll try to use the path /assets/office_vibe.webp assuming I'll move it or it is there.
// If not, I will fix it later.
// Actually, I should probably use the import if I want to be safe with existing structure,
// but Next.js App Router prefers public folder for static.
// I'll check the dir output first.
...
const ContentClient = () => {
    ...
    const handleContact = () => {
        if (window.innerWidth < 768) {
            router.push('/contact?subject=Création de Contenu');
        } else {
    ...
    return (
        <div className="pt-32 md:pt-40 pb-20 px-4 md:px-6 relative overflow-hidden bg-black text-white">
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                >
                    <span className="text-green-400 font-bold tracking-[0.2em] uppercase text-[10px] mb-6 inline-block">Brand Content</span>
