...
import { ArrowRight, Camera, User, ShoppingBag, Sun, Layers, Zap, Search, CheckCircle, Image as ImageIcon } from "lucide-react";
...
const PhotographyClient = () => {
    ...
    const handleContact = () => {
        if (window.innerWidth < 768) {
            router.push('/contact?subject=Production Vidéo / Photo');
        } else {
    ...
    return (
        <div className="pt-32 md:pt-40 pb-20 px-4 md:px-6 relative overflow-hidden bg-black text-white">
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                >
                    <span className="text-blue-400 font-bold tracking-[0.2em] uppercase text-[10px] mb-6 inline-block">Studio Photo</span>
